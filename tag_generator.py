...
def main():
    ...
    folder_path = "/Users/dream_exp/Desktop/Projects/ikyoukoujitsu-v2/public/images"  # 画像ファイルがあるフォルダのパスを指定してください
    ...
    for image_name in matching_images:
        ...
        print(f'<img src="/images/{image_name}" alt={{meta.name}}  width={{{width}}} height={{{height}}} />')
